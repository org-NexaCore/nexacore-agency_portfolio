...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <section ref={heroRef} className="relative min-h-[60vh] overflow-hidden">
        ...
        >
          <motion.img
            ...
            alt=""
            className="w-full h-auto object-contain opacity-[0.5] dark:opacity-[0.06]"
            animate={{
              y: [0, -18, 0],
              rotate: [0, 1.5, 0],
            }}
            ...
            {[
              {
                ...
                a: "We usually respond within 24 hours during business days.",
              },
              {
                q: "Do you work with startups?",
                a: "Absolutely! We love helping startups bring their ideas to life.",
              },
              {
                q: "What's your pricing model?",
                a: "We offer flexible pricing based on project scope and requirements.",
              },
              {
                q: "Do you offer maintenance?",
                a: "Yes, we provide ongoing maintenance and support packages.",
              },
            ].map((faq, i) => (
              <motion.div
                key={i}
          ...
          <ScrollReveal>
            ...
            >
              ...
              <p className="text-muted-foreground text-lg mb-8">
                Fill out the form above or reach out directly. We're excited to
