...
import { ArrowRight, Code2, Smartphone, Palette, Zap, Users, Shield, CheckCircle, Award, Rocket, Heart, Star, TrendingUp, Play, Sparkles, Globe, Coffee, Lightbulb } from "lucide-react";
...
const AnimatedCounter = ({ target, label, suffix = "+" }: { target: number; label: string; suffix?: string }) => {
  ...
  return (
    <motion.div
      ...
      className="text-center p-6 bg-gradient-to-br from-card/50 to-card/30 rounded-xl border border-border backdrop-blur-sm hover:border-accent/30 transition-all duration-300"
    >
      <div className="text-4xl sm:text-5xl font-bold text-accent mb-2">{count}{suffix}</div>
...
export default function Home() {
  ...
  const features = [
    { 
      ...
      description: "Built with cutting-edge frameworks and tools that set industry standards.",
      gradient: "from-orange-500 to-accent"
    },
    { 
      icon: TrendingUp,
      title: "Scalable Architecture", 
      description: "Systems designed to grow seamlessly with your business needs.",
      gradient: "from-blue-500 to-cyan-500"
    },
    { 
      icon: Zap,
      title: "Fast Delivery", 
      description: "Rapid development cycles without ever compromising on quality.",
      gradient: "from-yellow-500 to-orange-500"
    },
    { 
      icon: CheckCircle,
      title: "Clean Code", 
      description: "Maintainable, well-documented codebase that stands the test of time.",
      gradient: "from-green-500 to-emerald-500"
    },
    { 
      icon: Star,
      title: "Premium UX/UI", 
      description: "Pixel-perfect designs that convert visitors into loyal customers.",
      gradient: "from-purple-500 to-pink-500"
    },
    { 
      icon: Heart,
      title: "Ongoing Support", 
      description: "Dedicated support and maintenance long after your project launches.",
      gradient: "from-red-500 to-rose-500"
    },
  ];
    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <section ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 -z-10">
          <motion.div
            className="absolute top-0 left-1/4 w-96 h-96 bg-gradient-to-br from-accent to-transparent rounded-full blur-3xl opacity-40"
            animate={{
              y: [0, 50, 0],
              x: [0, 30, 0],
              scale: [1, 1.2, 1],
          ...
          />
          <motion.div
            className="absolute bottom-0 right-1/4 w-96 h-96 bg-gradient-to-br from-sky-500 to-transparent rounded-full blur-3xl opacity-30"
            animate={{
              y: [0, -50, 0],
              x: [0, -30, 0],
              scale: [1, 1.3, 1],
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <motion.div
            className="absolute top-1/4 right-1/4 w-32 h-32 border border-accent/20 rounded-2xl"
            animate={{
              rotate: 360,
              scale: [1, 1.1, 1],
            }}
          ...
          />
          <motion.div
            className="absolute bottom-1/3 left-1/4 w-20 h-20 border border-sky-500/20 rounded-full"
            animate={{
              rotate: -360,
              scale: [1, 1.2, 1],
            }}
          ...
          />
          <motion.div
            className="absolute top-2/3 right-1/3 w-16 h-16 bg-accent/5 rounded-lg"
            animate={{
              rotate: 45,
              scale: [1, 1.3, 1],
            }}
        ...
        >
          ...
          >
            ...
            <span className="text-sm font-semibold text-accent">Next-Gen Digital Agency</span>
          </motion.div>
          ...
          >
            We design and develop modern web, mobile, and software solutions that drive business growth.
          </motion.p>
          ...
          >
            <span className="font-semibold">✨ Built by a lean team of two founders</span>
      ...
      <section className="py-16 bg-gradient-to-r from-card/30 via-card/20 to-card/30 border-y border-border overflow-hidden">
        <div className="container">
          <ScrollReveal>
            ...
            <div className="flex flex-wrap justify-center gap-8 opacity-70">
              {["TechCorp", "InnovateLabs", "FutureStack", "DigitalWave", "CodeCraft", "DevSphere"].map((name, i) => (
                <motion.div
                  key={i}
                  initial={{ opacity: 0, scale: 0.8 }}
        ...
        <div className="container">
          <ScrollReveal>
            <div className="text-center mb-16">
              <span className="text-accent text-sm font-mono mb-2 block">WHAT WE CREATE</span>
              <h2 className="text-4xl sm:text-5xl font-bold mb-4 gradient-text">Services We Offer</h2>
              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10">
                    <div className={`w-12 h-12 mb-4 rounded-lg bg-gradient-to-br ${service.gradient} flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}>
      ...
      <section className="py-24 bg-gradient-to-br from-card/30 via-background to-card/30 border-y border-border">
        <div className="container">
          <ScrollReveal>
            <div className="text-center mb-16">
              <span className="text-accent text-sm font-mono mb-2 block">WHY CHOOSE US</span>
              <h2 className="text-4xl sm:text-5xl font-bold mb-4">
                Why <span className="gradient-text">NexaCore</span>
              </h2>
              <p className="text-muted-foreground text-lg">What makes us different from the rest</p>
            </div>
          </ScrollReveal>
      ...
      <section className="py-24">
        <div className="container">
          <ScrollReveal>
            <div className="text-center mb-16">
              <span className="text-accent text-sm font-mono mb-2 block">OUR IMPACT</span>
              <h2 className="text-4xl sm:text-5xl font-bold mb-4">By the Numbers</h2>
              <p className="text-muted-foreground text-lg">What we've achieved so far</p>
            </div>
          </ScrollReveal>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <AnimatedCounter target={100} label="Client Satisfaction" suffix="%" />
        ...
        <div className="container">
          <ScrollReveal>
            <div className="text-center mb-16">
              ...
              <p className="text-muted-foreground text-lg">The passionate minds behind NexaCore</p>
            </div>
          </ScrollReveal>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-4xl mx-auto">
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-br from-accent/20 to-sky-500/20 rounded-2xl blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              <div className="relative text-center p-8 bg-gradient-to-br from-card/50 to-card/30 rounded-2xl border border-border group-hover:border-accent/30 transition-all duration-300">
                <div className="relative w-36 h-36 mx-auto mb-6">
                  <div className="absolute inset-0 bg-gradient-to-br from-accent to-sky-500 rounded-full opacity-20 group-hover:opacity-40 transition-opacity duration-300 animate-pulse" />
                  <img
                    src={abdelhakimImg}
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  Full-stack developer passionate about building scalable systems and creating exceptional digital experiences.
                </p>
              </div>
            </motion.div>
