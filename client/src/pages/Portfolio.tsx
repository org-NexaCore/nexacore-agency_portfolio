...
import { X, ArrowRight, Sparkles, Play, Calendar, Code2, Smartphone, Palette, Zap, Users, Shield } from "lucide-react";
...
const projects = [
  {
    ...
    icon: Code2,
    description: "A full-featured e-commerce platform with real-time inventory management and payment processing. Processed over $1M in transactions.",
  ...
  },
  {
    ...
    icon: Smartphone,
    description: "Cross-platform fitness tracking app with workout plans and social features. Achieved 100K+ downloads in first month.",
  ...
  },
  {
    ...
    icon: Zap,
    description: "Scalable CRM system for managing customer relationships and sales pipelines. Used by 500+ enterprise clients.",
  ...
  },
  {
    ...
    category: "Mobile Development",
    icon: Smartphone,
    description: "Native iOS app for health monitoring with Apple Watch integration. Featured in App Store.",
    tech: ["Swift", "HealthKit", "CloudKit"],
    year: "2024",
    impact: "Featured",
    videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
    image: "https://images.unsplash.com/photo-1526374965328-7f5ae4e8b69e?w=800&h=600&fit=crop",
  },
  {
    id: 5,
    ...
    category: "Web Development",
    icon: Code2,
    description: "Real-time analytics dashboard with custom visualizations and data export. Processing 10M+ data points daily.",
  ...
  },
  {
    ...
    icon: Palette,
    description: "Complete design system for enterprise applications. Used by 50+ designers across the organization.",
  ...
  },
  {
    ...
    category: "Software Engineering",
    icon: Zap,
    description: "AI-powered content generation tool with natural language processing. Generated 1M+ articles.",
    tech: ["Python", "TensorFlow", "FastAPI", "React"],
    year: "2024",
    impact: "1M+ Articles",
    videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
    image: "https://images.unsplash.com/photo-1677442d019cecf8d424d0acda32e5f56?w=800&h=600&fit=crop",
  },
  {
    id: 8,
    ...
    icon: Shield,
    description: "Comprehensive IT consulting platform for digital transformation. Served 20+ enterprise clients.",
...
export default function Portfolio() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <section ref={projectsContainerRef} className="py-20 relative overflow-hidden">
                    ...
                    <div className={`md:w-1/2 ${isEven ? 'md:text-right pr-8' : 'md:text-left pl-8'}`}>
                      <div className="bg-card/50 p-6 rounded-xl border border-accent/20 backdrop-blur-sm hover:border-accent/50 transition-all duration-500 hover:-translate-y-2 group-hover:shadow-2xl group-hover:shadow-accent/10">
                        <div className="flex items-center gap-2 mb-3 flex-wrap">
                          <span className="text-accent text-sm font-mono">{project.year}</span>
      ...
      <section className="py-32 relative overflow-hidden">
        ...
        <div className="container text-center relative">
          ...
          >
            <h2 className="text-4xl sm:text-5xl font-bold mb-4 gradient-text">Ready to Build Something Amazing?</h2>
            <p className="text-muted-foreground text-lg mb-8">
              Let's create something extraordinary together. We're just a message away.
            </p>
            ...
            >
              ...
              <div className="p-8">
                <div className="flex items-center justify-between mb-4 flex-wrap gap-2">
                  <h2 className="text-3xl font-bold gradient-text">{selectedProject.title}</h2>
                ...
                <div className="mb-6 p-4 bg-accent/5 rounded-lg border border-accent/10">
                  ...
                  <p className="text-accent text-lg font-bold">{selectedProject.impact}</p>
                </div>
