...
import { X, ArrowRight, Sparkles, Code2, Smartphone, Palette, Zap, Shield, Users, Play, Rocket, Clock, CheckCircle } from "lucide-react";
...
const services = [
  {
    ...
    longDescription: "We create responsive, high-performance web applications using React, Next.js, and Node.js. Our solutions are designed to scale with your business and provide exceptional user experiences.",
    tech: ["React", "Next.js", "Node.js", "PostgreSQL", "TypeScript"],
    year: "2024",
    impact: "50+ Websites",
    videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
    image: "https://images.unsplash.com/photo-1461749280691-d6ccab1d605c?w=800&h=600&fit=crop",
  },
  {
    id: 2,
    ...
    longDescription: "From concept to app store, we develop native and cross-platform mobile applications that users love. We specialize in React Native and Flutter for maximum reach.",
  ...
  },
  {
    ...
    longDescription: "Our design team creates pixel-perfect interfaces with a focus on user experience. We combine aesthetics with functionality to create products that users genuinely enjoy.",
    tech: ["Figma", "Framer", "Tailwind CSS", "Design Systems", "User Research"],
    year: "2024",
  ...
  },
  {
    ...
    longDescription: "We engineer robust, maintainable software solutions that solve real business problems. From backend systems to complex algorithms, we deliver excellence.",
  ...
  },
  {
    ...
    longDescription: "Our consultants help you navigate the digital landscape. We provide strategic advice on technology choices, architecture, and best practices.",
    tech: ["Cloud Architecture", "DevOps", "Security", "Scalability", "Performance"],
    year: "2024",
  ...
  },
  {
    ...
    longDescription: "We provide comprehensive maintenance and support services to ensure your systems remain secure, performant, and up-to-date.",
    tech: ["Monitoring", "Debugging", "Updates", "Security Patches", "Performance Optimization"],
    year: "2024",
    impact: "24/7 Support",
    videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
...
export default function Services() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <section ref={servicesContainerRef} className="py-20 relative overflow-hidden">
        <div className="container max-w-4xl mx-auto px-4">
          <div className="relative">
            {/* Glowing vertical line */}
            <div 
              ref={lineRef}
              className="absolute left-8 md:left-1/2 top-0 w-0.5 bg-gradient-to-b from-accent via-accent/50 to-transparent h-0"
              ...
              return (
                ...
                >
                  <div className={`flex flex-col md:flex-row items-center gap-8 ${isEven ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
                    {/* Content Card */}
                    <div className={`md:w-1/2 ${isEven ? 'md:text-right pr-8' : 'md:text-left pl-8'}`}>
                      <div className="bg-card/50 p-6 rounded-xl border border-accent/20 backdrop-blur-sm hover:border-accent/50 transition-all duration-500 hover:-translate-y-2 group-hover:shadow-2xl group-hover:shadow-accent/10">
                        <div className="flex items-center gap-2 mb-3 flex-wrap justify-between">
                          <span className="text-accent text-sm font-mono">{service.year}</span>
                        ...
                        <div className="flex flex-wrap gap-2 mb-4">
                          {service.tech.slice(0, 3).map((tech) => (
                            <span key={tech} className="text-xs bg-accent/10 text-accent/80 px-2 py-1 rounded">
                              {tech}
                            </span>
                          ))}
                        </div>
      ...
      <section className="py-32 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-accent/10 via-accent/5 to-transparent"></div>
        <div className="container text-center relative">
          ...
          >
            <h2 className="text-4xl sm:text-5xl font-bold mb-4 gradient-text">Ready to Get Started?</h2>
        ...
        {selectedService && (
          ...
          >
            ...
            >
              ...
              <div className="p-8">
                <p className="text-muted-foreground mb-6 leading-relaxed">{selectedService.longDescription}</p>
                ...
                <div className="mb-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {selectedService.tech.map((t) => (
                      <span key={t} className="bg-accent/10 text-accent px-3 py-1 rounded-full text-sm">
                        {t}
                      </span>
                    ))}
                  </div>
                ...
                <div className="mb-6 p-4 bg-accent/5 rounded-lg border border-accent/10">
                  ...
                  <p className="text-accent text-lg font-bold">{selectedService.impact}</p>
                </div>
